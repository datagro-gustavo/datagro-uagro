...
const CardInstagram = () => {
    ...
    return (
        <CardWrapper>
                ...
                <button onClick={() => setPlay(true)} className=" w-[216.09px] h-[285.16px]  inset-0 w-full h-full">
                    <Image src={thumb} alt=""  width={300} height={300} className="w-full h-full object-cover block"/>
