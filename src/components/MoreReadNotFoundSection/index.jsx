...
const MoreReadNotFoundSection = ({ scrolled }) => {
    const navigate = useNavigate()
    const config = getSessionConfig("s-mais-lidas-not-found");
    if (!config) return null;

    return (
        <section style={{ marginTop: "0rem"}} className=" xl:max-w-[1280px] 2xl:max-w-[1650px]  mx-auto px-5 ">
...
export default MoreReadNotFoundSection;
