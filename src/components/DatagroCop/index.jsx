...
const DatagroCop = ({ scrolled }) => {
    const navigate = useNavigate()
    const config = getSessionConfig("datagro-cop");
    if (!config) return null;

    return (
        <section className=" xl:max-w-[1280px] 2xl:max-w-[1650px] mx-auto px-0 mt-5">
